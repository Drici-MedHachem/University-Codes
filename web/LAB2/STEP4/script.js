            ...
            success: function (response) {
                ...
                if (response.success) {
                    ...
                    $('#result').html(
                        ...
                        response.message +
                        '</div>' +
                        '<div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="' + response.prog + '" aria-valuemin="0" aria-valuemax="100">' +
                            '<div class="progress-bar" style="width: ' + response.prog + '%">' + response.interpretation + '</div>' +
                        '</div>'
                        +
                        response.tableHtml
                    );
